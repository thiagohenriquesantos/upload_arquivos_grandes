...
class ArquivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arquivo" do
    assert_difference('Arquivo.count') do
      post arquivos_url, params: { arquivo: { nome: @arquivo.nome, processado: @arquivo.processado, url_arquivo: @arquivo.url_arquivo } }
    end
  ...
  test "should update arquivo" do
    patch arquivo_url(@arquivo), params: { arquivo: { nome: @arquivo.nome, processado: @arquivo.processado, url_arquivo: @arquivo.url_arquivo } }
